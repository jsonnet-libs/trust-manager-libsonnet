---
permalink: /0.20/trust/v1alpha1/bundle/
---

# trust.v1alpha1.bundle
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.sources`](#obj-specsources)
    * [`fn withInLine(inLine)`](#fn-specsourceswithinline)
    * [`fn withUseDefaultCAs(useDefaultCAs)`](#fn-specsourceswithusedefaultcas)
    * [`obj spec.sources.configMap`](#obj-specsourcesconfigmap)
      * [`fn withIncludeAllKeys(includeAllKeys)`](#fn-specsourcesconfigmapwithincludeallkeys)
      * [`fn withKey(key)`](#fn-specsourcesconfigmapwithkey)
      * [`fn withName(name)`](#fn-specsourcesconfigmapwithname)
      * [`obj spec.sources.configMap.selector`](#obj-specsourcesconfigmapselector)
        * [`fn withMatchExpressions(matchExpressions)`](#fn-specsourcesconfigmapselectorwithmatchexpressions)
        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specsourcesconfigmapselectorwithmatchexpressionsmixin)
        * [`fn withMatchLabels(matchLabels)`](#fn-specsourcesconfigmapselectorwithmatchlabels)
        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specsourcesconfigmapselectorwithmatchlabelsmixin)
        * [`obj spec.sources.configMap.selector.matchExpressions`](#obj-specsourcesconfigmapselectormatchexpressions)
          * [`fn withKey(key)`](#fn-specsourcesconfigmapselectormatchexpressionswithkey)
          * [`fn withOperator(operator)`](#fn-specsourcesconfigmapselectormatchexpressionswithoperator)
          * [`fn withValues(values)`](#fn-specsourcesconfigmapselectormatchexpressionswithvalues)
          * [`fn withValuesMixin(values)`](#fn-specsourcesconfigmapselectormatchexpressionswithvaluesmixin)
    * [`obj spec.sources.secret`](#obj-specsourcessecret)
      * [`fn withIncludeAllKeys(includeAllKeys)`](#fn-specsourcessecretwithincludeallkeys)
      * [`fn withKey(key)`](#fn-specsourcessecretwithkey)
      * [`fn withName(name)`](#fn-specsourcessecretwithname)
      * [`obj spec.sources.secret.selector`](#obj-specsourcessecretselector)
        * [`fn withMatchExpressions(matchExpressions)`](#fn-specsourcessecretselectorwithmatchexpressions)
        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specsourcessecretselectorwithmatchexpressionsmixin)
        * [`fn withMatchLabels(matchLabels)`](#fn-specsourcessecretselectorwithmatchlabels)
        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specsourcessecretselectorwithmatchlabelsmixin)
        * [`obj spec.sources.secret.selector.matchExpressions`](#obj-specsourcessecretselectormatchexpressions)
          * [`fn withKey(key)`](#fn-specsourcessecretselectormatchexpressionswithkey)
          * [`fn withOperator(operator)`](#fn-specsourcessecretselectormatchexpressionswithoperator)
          * [`fn withValues(values)`](#fn-specsourcessecretselectormatchexpressionswithvalues)
          * [`fn withValuesMixin(values)`](#fn-specsourcessecretselectormatchexpressionswithvaluesmixin)
  * [`obj spec.target`](#obj-spectarget)
    * [`obj spec.target.additionalFormats`](#obj-spectargetadditionalformats)
      * [`obj spec.target.additionalFormats.jks`](#obj-spectargetadditionalformatsjks)
        * [`fn withKey(key)`](#fn-spectargetadditionalformatsjkswithkey)
        * [`fn withPassword(password)`](#fn-spectargetadditionalformatsjkswithpassword)
      * [`obj spec.target.additionalFormats.pkcs12`](#obj-spectargetadditionalformatspkcs12)
        * [`fn withKey(key)`](#fn-spectargetadditionalformatspkcs12withkey)
        * [`fn withPassword(password)`](#fn-spectargetadditionalformatspkcs12withpassword)
        * [`fn withProfile(profile)`](#fn-spectargetadditionalformatspkcs12withprofile)
    * [`obj spec.target.configMap`](#obj-spectargetconfigmap)
      * [`fn withKey(key)`](#fn-spectargetconfigmapwithkey)
    ...
    * [`obj spec.target.secret`](#obj-spectargetsecret)
      * [`fn withKey(key)`](#fn-spectargetsecretwithkey)
...
new returns an instance of Bundle
...
### fn spec.sources.withUseDefaultCAs

```ts
withUseDefaultCAs(useDefaultCAs)
```
...
### fn spec.sources.configMap.withIncludeAllKeys

```ts
withIncludeAllKeys(includeAllKeys)
```
...
### fn spec.sources.configMap.withKey
...
### fn spec.sources.configMap.withName
...
## obj spec.sources.configMap.selector

"Selector is the label selector to use to fetch a list of objects. Must not be set\nwhen `Name` is set."

### fn spec.sources.configMap.selector.withMatchExpressions
...
### fn spec.sources.configMap.selector.withMatchExpressionsMixin
...
### fn spec.sources.configMap.selector.withMatchLabels
...
### fn spec.sources.configMap.selector.withMatchLabelsMixin
...
## obj spec.sources.configMap.selector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.sources.configMap.selector.matchExpressions.withKey
...
### fn spec.sources.configMap.selector.matchExpressions.withOperator
...
### fn spec.sources.configMap.selector.matchExpressions.withValues
...
### fn spec.sources.configMap.selector.matchExpressions.withValuesMixin
...
### fn spec.sources.secret.withIncludeAllKeys
...
### fn spec.sources.secret.withKey
...
### fn spec.sources.secret.withName
...
## obj spec.sources.secret.selector

"Selector is the label selector to use to fetch a list of objects. Must not be set\nwhen `Name` is set."

### fn spec.sources.secret.selector.withMatchExpressions
...
### fn spec.sources.secret.selector.withMatchExpressionsMixin
...
### fn spec.sources.secret.selector.withMatchLabels
...
### fn spec.sources.secret.selector.withMatchLabelsMixin
...
## obj spec.sources.secret.selector.matchExpressions

"matchExpressions is a list of label selector requirements. The requirements are ANDed."

### fn spec.sources.secret.selector.matchExpressions.withKey
...
### fn spec.sources.secret.selector.matchExpressions.withOperator
...
### fn spec.sources.secret.selector.matchExpressions.withValues
...
### fn spec.sources.secret.selector.matchExpressions.withValuesMixin
...
## obj spec.target.additionalFormats

"AdditionalFormats specifies any additional formats to write to the target"

## obj spec.target.additionalFormats.jks
...
### fn spec.target.additionalFormats.jks.withKey
...
### fn spec.target.additionalFormats.jks.withPassword
...
### fn spec.target.additionalFormats.pkcs12.withPassword
...
### fn spec.target.additionalFormats.pkcs12.withProfile
...
### fn spec.target.configMap.withKey
